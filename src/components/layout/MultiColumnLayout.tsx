            ...
            >
                ...
                >
                    <nav aria-label="Sidebar" className="h-screen sticky top-0">
                        ...
                        <div
                            className="flex flex-col h-full border-r border-gray-200 bg-gray-50 dark:bg-gray-900 dark:border-gray-700">
                ...
                {outlineView && (
                    <aside className="hidden lg:block lg:col-span-3 xl:col-span-2">
                        <div
                            className="sticky max-h-screen top-0 space-y-4 overflow-y-auto py-4 scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-700">
